...
<html>
<head>
<title>FTA | Admin Package Creation</title>
...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"></i>Update Package </li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
...
<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="packagetype" id="packagetype" placeholder=" Package Type eg- Single/Group" required>
									</div>
								</div>
...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Package Price in CAD</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="packageprice" id="packageprice" placeholder=" Package Price is CAD" required>
									</div>
								</div>
